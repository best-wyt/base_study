...
public class PrimMSTTest {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //准备一副加权无向图
        BufferedReader br = new BufferedReader(new InputStreamReader(ClassLoader.getSystemClassLoader().getResourceAsStream("min_create_tree_test.txt")));
//        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("min_create_tree_test.txt"))));
