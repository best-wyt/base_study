...
import com.wang.annotation.SystemControllerLog;
import com.wang.annotation.SystemServiceLog;
...
public class SystemLogAspect {
    ...
    /**
           ...
           */
    @Pointcut("@annotation(com.wang.annotation.SystemServiceLog)")
    public void serviceAspect(){
    }

    //Controller层切点
    @Pointcut("@annotation(com.wang.annotation.SystemControllerLog)")
